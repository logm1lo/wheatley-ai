...
#define DRV_AUDIO_SAMPLE_RATE (8000)
...
#define BSP_I2S_SLOT_CONFIG(bits_per_sample, mono_or_stereo) \
    {                                                        \
        .data_bit_width = bits_per_sample, .slot_bit_width = I2S_SLOT_BIT_WIDTH_AUTO, .slot_mode = mono_or_stereo, .slot_mask = I2S_STD_SLOT_BOTH, .ws_width = bits_per_sample, .ws_pol = false, .bit_shift = true, .left_align = true, .big_endian = false, .bit_order_lsb = false}
